...
uint32_t trialTime = 35000; // length of step change trials
File SDdata;
...
/*for power calculations */
  ...
  // decreasing sin wave
   if (currentMillis-startTime < endTime){
   beepDif = a1*pow(0.999992, currentMillis)*sin(currentMillis*pi*0.000025)+ basetimeDif;   
   
  } 
  // step changes
   if (currentMillis - lasttrialTime >= trialTime&&currentMillis-startTime >= endTime&&bpmcounter < 15){
